    ...
    return (
        <header className="w-full bg-white shadow-md flex flex-col md:flex-row justify-between px-10 py-4 md:py-0 h-auto md:h-16">
            <div className="flex items-center gap-4 mb-2 md:mb-0">
                <button onClick={() => dispatch(toggleSidebar())} className="p-2 rounded hover:bg-gray-100 transition">
            ...
            <div className="flex items-center gap-2 mt-2 md:mt-0">
                <button onClick={handleLogout} className="p-2 rounded hover:bg-gray-100 transition">
